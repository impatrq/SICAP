...
SECRET_KEY = "django-insecure-q178fi8jps&dvi*5n)ecr@*1pq2q6=+%kp@w#xwbbq^m40s9%e"
...
# Activar internacionalización (i18n).
# Cuando USE_I18N = True Django carga la infraestructura para traducciones
# (gettext, archivos .po/.mo, etiquetas {% trans %} en plantillas, etc.).
# Mantener True si se planea soportar múltiples idiomas o usar traducciones
# en la interfaz. No traduce automáticamente nada: hace falta proveer los
# ficheros de traducción o marcar las cadenas con gettext.
USE_I18N = True
